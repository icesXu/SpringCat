...
public class MessageConstants {
	 ...
	 * 服务鉴权
	 */
	public static final String EMAIL_SMTP_TIMEOUT = "mail.smtp.timeout";
	/**
	 * 邮件服务器用户名
	 */
	...
	public static final String EMAIL_SMTP_STARTTLS = "mail.smtp.starttls.enable";
	public static final String EMAIL_SMTP_TRUST = "mail.smtp.ssl.trust";
}
