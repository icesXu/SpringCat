...
public class SpiderJsoupUtil {
	...
	public static Response getContent(String url, Map<String, String> data,
		...
		return getContent(url, data, cookies, Method.GET, null, null, 0, 10);
	}
	...
	public static Response getContent(String url, Map<String, String> data,
		...
		return getContent(url, data, cookies, m, null, null, 0, 10);
	}
	...
	public static Response getContent(String url, Map<String, String> data,
		...
		return getContent(url, data, cookies, method, header, null, 0, 10);
	}
	...
	public static Response getContent(String url, Map<String, String> data,
		...
		return getContent(url, data, cookies, method, header, ip, port, 10);
	}
	...
	public static Response getContent(String url, Map<String, String> data,
			...
			throws Exception {
		return getContent(url, data, cookies, method, header, ip, port, 300000,
				retry > 0 ? retry : 2);
	}
	...
	public static Response getContent(String url, Map<String, String> data,
			Map<String, String> cookies, Method method,
			Map<String, String> header, String ip, int port, int timeout,
		...
		if (retry > 0) {
			while (retry > 0) {
				try {
					...
					res = null;
					ioE = e;
					System.out.println(e + "  jsoup链接失败 url:" + url + " ip:"
							+ ip + " 重试");
				}
				retry--;
				if (null != res) {
	...
	public static void main(String[] args) throws Exception {
		for (int i = 100; i < 1000; i++) {
			String url = "https://login.10086.cn/captchazh.htm?type=" + i;
			Response content = getContent(url, null, null);
			System.out.println(i + "  :" + content.body().length());
		}
	}
}